...
theme.default_height = 18
theme.font           = "ohsnap 12"
--theme.font           = "Lucida Grande 11"
--theme.font           = "Noto Sans S Chinese 10"
--theme.font           = "Dejavu Sans mono 10"
--theme.font           = "terminus mono 9"

theme.path           = path

theme.bg_normal      = "#2B2B2C"
theme.bg_focus       = "#496477"
theme.bg_urgent      = "#5B0000"
theme.bg_minimize    = "#040A1A"
theme.bg_highlight   = "#424242"
--theme.bg_alternate   = "#081B37"
theme.bg_alternate   = "#373737"
--theme.bg_allinone    = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#1D4164" }, { 1, "#0D2144" }}}
theme.bg_allinone    = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#333333" }, { 1, "#0D2144" }}}
...
theme.icon_grad        = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#D7D7D7" }, { 1, "#D7D7D7" }}}
--theme.icon_mask        = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#8AC2D5" }, { 1, "#3D619C" }}}
theme.icon_mask        = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#D7D7D7" }, { 1, "#D7D7D7" }}}
--theme.icon_grad_invert = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#000000" }, { 1, "#112543" }}}
theme.icon_grad_invert = { type = "linear", from = { 0, 0 }, to = { 0, 20 }, stops = { { 0, "#838485" }, { 1, "#838485" }}}
...
theme.fg_dock                   = { type = "linear", from = { 0, 0 }, to = { 0, sh }, stops = { { 0, "#3D3E40" }, { 1, "#333333" }}}

theme.wallpaper = "/home/eaufavor/.config/awesome/sky.png"
...
wibox_w.textbox.draw1 = function(self,w, cr, width, height,args)
    --Create the cache
