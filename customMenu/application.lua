...
--     mylaunchertext._layout:set_width(pango.units_from_double(9999))
    ...
    local img2 = cairo.ImageSurface.create(cairo.Format.ARGB32,wdg_width+50+beautiful.default_height, beautiful.default_height)
    ...
    img2 = themeutils.compose({img2,{layer=ic,matrix=matrix},{layer=arr2,x=beautiful.default_height},{layer = arr,y=0,x=wdg_width+34+beautiful.default_height}})
