...
local function refreshStat()
    ...
    local process
    util.spawn("/bin/bash -c '"..util.getdir("config") .."/Scripts/topMem2.sh > /tmp/topMem.lua'")
...
local function repaint()
  mainMenu = menu({arrow_x=90,nokeyboardnav=true,item_width=298,width=300,arrow_type=radical.base.arrow_type.CENTERED})
  mainMenu:add_widget(radical.widgets.header(mainMenu,"USAGE"),{height = 20 , width = 300})
  ...
  mainMenu:add_widget(radical.widgets.header(mainMenu,"USERS"),{height = 20, width = 300})
  local memStat
  ...
  mainMenu:add_widget(radical.widgets.header(mainMenu,"STATE"),{height = 20 , width = 300})
  ...
  mainMenu:add_widget(radical.widgets.header(mainMenu,"PROCESS",{suffix_widget=imb}),{height = 20 , width = 300})
